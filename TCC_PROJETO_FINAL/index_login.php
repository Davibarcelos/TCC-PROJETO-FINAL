...
<body>
    <header>
        <nav class="menu">
            <ul>
                <img id="logo" src="imagens/logo.png" alt="logo" height="90px">
                <a href="index.php"><li>Home</li></a>
                <a href="form-perdido.html"><li>Cadastro</li></a>
                <a href="ongs.html"><li>O.N.G.'s</li></a>
                <a href="adote.html"><li>Adote</li></a>
                <a href="./Pag-login/index.php"><li>Login</li></a>
            </ul>
        </nav>
    </header>
    <main>
